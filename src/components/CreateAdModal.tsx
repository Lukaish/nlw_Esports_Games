...
export function CreateAdModal() {
    ...
    async function handleCreateaAd(event: FormEvent) {
        ...
        try {
            ...
            alert('Cadastro realizado com seucesso!');
        } catch (error) {
            console.log(error);
    ...
    return (
        <Dialog.Portal>
          ...
          shadow-lg shadow-black/25'>
                ...
                <form onSubmit={handleCreateaAd} className='mt-8 flex flex-col gap-4'>
                    <div className='flex flex-col gap-2'>
                        <label className='font-semibold' htmlFor="game">Qual o Game?</label>
                        <select id="game"
                            name='game'
                            className='bg-zinc-900 py-3 px-4 rounded text-sm placeholder:text-zinc-700'
                            defaultValue=""
                        >
